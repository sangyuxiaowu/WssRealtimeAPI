...
// ArrayBuffer 转换为 Blob，并添加 WAV 头部
...
tool.addWavHeader = function (samples, sampleRateTmp, sampleBits, channelCount) {
    ...
    // 新的 buffer 类，预留 44 bytes 的 header 空间
...
// 将 PCM 数据转换为 WAV 格式的 Base64 字符串
